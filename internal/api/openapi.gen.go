...
type PRStats struct {
	...
	// ReviewersCount Количество назначенных ревьюверов (0-2)
	ReviewersCount int           `json:"reviewers_count"`
	Status         PRStatsStatus `json:"status"`
}
...
type ReviewerStats struct {
	// MergedReviews Merged PR отремотрены
	MergedReviews int `json:"merged_reviews"`

	// OpenReviews Открытых PR к ревью
	OpenReviews int    `json:"open_reviews"`
	TeamName    string `json:"team_name"`

	// TotalReviews Всего назначений ревьювером
...
type StatisticsResponse struct {
	...
	// TotalPrs Всего PR в системе
	TotalPrs int `json:"total_prs"`

	// TotalReviewers Всего пользователей
...
type ServerInterface interface {
	...
	// Получить статистику по PR и ревьюверам
	// (GET /statistics)
